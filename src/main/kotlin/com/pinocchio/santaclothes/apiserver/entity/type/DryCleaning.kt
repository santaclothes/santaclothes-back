...
enum class DryCleaning(var code: Int, var nationType: NationType, var description: String, var imageUrl: String) {
    DRY_CLEANING_KR(0, NationType.KR, "드라이 클리닝이 가능합니다", "/img/dryCleaning/can.png"),
    ...
    DRY_CLEANING_NOT_HOT_USA(
        8,
        NationType.USA,
        "열을 줄여서 드라이 클리닝이 필요합니다",
        "/img/dryCleaning/ame_lowheat.png"
    ),
    DRY_CLEANING_JP(
        9,
        NationType.JP,
